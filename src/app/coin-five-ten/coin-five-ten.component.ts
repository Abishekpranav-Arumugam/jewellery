...
@Component({
  selector: 'app-coin-five-ten',
  templateUrl: './coin-five-ten.component.html',
  styleUrls: ['./coin-five-ten.component.css']
})
export class CoinFiveTenComponent {
  coins = [
    { name: '5 gram', price: 'Rs. 9,000', image: './assets/coins/5g1.jpg' },
    { name: '10 gram', price: 'Rs. 12,000', image: './assets/coins/10g2.jpg' },
    { name: '5 gram', price: 'Rs. 10,000', image: './assets/coins/5g2.jpg' },
    { name: '10 gram', price: 'Rs. 11,000', image: './assets/coins/R.jpg' }
  ];
